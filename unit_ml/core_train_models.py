...
MAX_TAGS = int(config.get('data', 'MAX_TAGS'))
...
# prints to file
logfile = f"{OUTPUT_PATH}train_logs.log"
...
with open(f'{OUTPUT_PATH}tokenizer.pickle', 'wb') as file:
...
for target in target_names:
    ...
    TRAINING_OUTPUT_DIR = f'{OUTPUT_PATH}{target}_training/'
...
with open(f"{OUTPUT_PATH}train_record.cfg", 'w') as file:
    config.write(file)
