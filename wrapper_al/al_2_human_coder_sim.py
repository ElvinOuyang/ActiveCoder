...
arg_parser = argparse.ArgumentParser(description='Run human coder sim based on config file')
arg_parser.add_argument('--config_path', metavar='config_path', default='./al_2_coding_sim.cfg',
...
LABEL_PATH = config.get('data', 'LABEL_PATH')
...
SAMPLE_FILE = f"{SAMPLE_PATH}/text_tags.json"
